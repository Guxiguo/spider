...
def group_info(group_info_file,content_list,date,Massage_id,group_number,sender_type,true_time,data_id_list,user_name,types,time2,number,start_time,information_path,message_count):
    if len(data_id_list) == 1:
        ...
        for data in data_id_list:
            ...
            json.dump(messages,group_info_file,ensure_ascii=False) 
            message_count = message_count+1
    return Massage_id,message_count,start_time
...
def read_div(div_list,group_number,is_group,group_name,group_user_number,i,url,Massage_id,member_list,user_detail_file,group_detial_file,group_relation_file,group_info_file,user_detial_id,user_relation_id,user_all_list,relation_all_list,group_list,flag,types,time2,number,start_time,information_path,message_count):
    ...
    for div in div_list:
        ...
        for content_main in chat_content[start_index:]:
            ...
            Massage_id,message_count,start_time = group_info(group_info_file,content_list,date,Massage_id,group_number,sender_type,true_time,data_id_list,user_name,types,time2,number,start_time,information_path,message_count)
    ...
    return Massage_id,user_detial_id,user_relation_id,user_all_list,relation_all_list,group_list,flag,message_count,start_time
...
def main1():
    ...
    relation_all_list = []
    group_list = []
    user_detail_path = save_path+'user.json'
    
    message_count = 0
    group_detial_path = save_path+'group.json'
    group_relation_path = save_path+'relation.json'
    group_info_path = save_path+'info.json'
    ...
    while (1):
        for i in range(1,len(group_user_number)+1):
            try:
                ...
                Massage_id,user_detial_id,user_relation_id,user_all_list,relation_all_list,group_list,flag,message_count,start_time = read_div(div_list,group_number,is_group,group_name,group_user_number,i,url1,Massage_id,member_list,user_detail_file,group_detial_file,group_relation_file,group_info_file,user_detial_id,user_relation_id,user_all_list,relation_all_list,group_list,flag,types,time2,number,start_time,information_path,message_count)
                state = 'run'
                save_information(information_path,start_time,state,Massage_id,user_detial_id,user_relation_id,i)
                time.sleep(int(number))
            except Exception:
