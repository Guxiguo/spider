 ...
 * @LastEditTime: 2023-06-29 15:19:33
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result.returnCode && isStart) {
                ...
                document.getElementsByName("run_comment")[0].innerHTML = result.comments;
...
//提交任务
$("[name='start_mewe']").click(function () {
    console.log("提交任务");
    isStart = true;
    ...
    $.ajax({
        ...
        data: {
            ...
            group: document.getElementsByName("group_url")[0].value,
